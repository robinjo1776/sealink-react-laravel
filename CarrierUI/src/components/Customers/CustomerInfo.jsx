    ...
    <fieldset>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) =>
            setformCustomer({ ...formCustomer, cust_ref_no: e.target.value })
          }
        />
      </div>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) =>
            setformCustomer({ ...formCustomer, cust_website: e.target.value })
          }
        />
      </div>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) =>
            setformCustomer({ ...formCustomer, cust_tax_id: e.target.value })
          }
        />
      </div>
    </fieldset>
