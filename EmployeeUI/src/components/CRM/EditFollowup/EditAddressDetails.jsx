      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, address: e.target.value })
            }
            id="address"
            ref={addressRef}
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, unit_no: e.target.value })
            }
            id="unitNo"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, city: e.target.value })
            }
            id="city"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, state: e.target.value })
            }
            id="state"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, country: e.target.value })
            }
            id="country"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setfollowupEdit({ ...followupEdit, postal_code: e.target.value })
            }
            id="postalCode"
          />
        </div>
