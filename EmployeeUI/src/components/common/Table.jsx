...
const Table = ({
  data = [], // Default to empty array if data is undefined or null
  headers,
  handleSort,
  sortBy,
  sortDesc,
...
Table.propTypes = {
  data: PropTypes.array, // Ensuring the 'data' prop is expected to be an array
...
// Setting default props in case 'data' is undefined
Table.defaultProps = {
  data: [],
};
