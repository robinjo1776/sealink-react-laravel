...
import LeadDetails from "./AddLead/LeadDetails";
import AddressDetails from "./AddLead/AddressDetails";
import AdditionalInfo from "./AddLead/AdditionalInfo";
          ...
          <div className="form-row">
            {lead.contacts.map((contact, index) => (
              <LeadContactForm
                ...
                contact={contact}
                index={index}
                onChange={handleContactChange} // Pass the handler
                onRemove={handleRemoveContact} // Pass the remove handler
              />
            ))}
            <button
              type="button"
              onClick={() =>
                setLead((prevLead) => ({
                  ...
                  contacts: [
                    ...prevLead.contacts,
                    { name: "", phone: "", email: "" }, // Add new empty contact
                  ],
                }))
              }
              className="add"
