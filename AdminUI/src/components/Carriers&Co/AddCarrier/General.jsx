      ...
      <div className="form-row">
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, legal_name: e.target.value })
            }
            id="legalName"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, remit_name: e.target.value })
            }
            id="remitName"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, website: e.target.value })
            }
            id="website"
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, fed_id_no: e.target.value })
            }
            id="fedIdNo"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, pay_terms: e.target.value })
            }
            id="payTerms"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setCarrier({ ...carrier, advertise_email: e.target.value })
            }
            id="advertiseEmail"
          />
        </div>
